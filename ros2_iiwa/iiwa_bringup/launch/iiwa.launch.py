...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description='World file to load in Gazebo. Options: empty.world, sphere.world',
        )
    )
    ###################################################
    ...
    use_vision = LaunchConfiguration('use_vision') ### aggiunta
    world_name = LaunchConfiguration('world_name') ### aggiunta
    ...
    iiwa_simulation_world = PathJoinSubstitution(   #change
    [
